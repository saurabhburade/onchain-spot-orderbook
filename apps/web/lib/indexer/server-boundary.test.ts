...
const marketsScreenSource = readFileSync(new URL("components/markets/markets-screen.tsx", webRoot), "utf8");
const tradingScreenSource = readFileSync(new URL("components/trading/trading-screen.tsx", webRoot), "utf8");
