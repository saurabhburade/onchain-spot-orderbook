...
documentation: Ankr for historical sync and Monad Foundation for realtime HTTP/WebSocket head
tracking. Historical Ankr `eth_getLogs` requests are capped at 999 block intervals
